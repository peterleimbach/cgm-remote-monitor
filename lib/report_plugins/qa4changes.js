...
qa4changes.report = function report_qa4changes(datastorage, sorteddaystoshow, options) {
  ...
  table.append($('<tr>').css('background','gray')
    ...
    .append($('<th>').css('width','250px').attr('align','left').append(translate('Duration')))
  );
  ...
  for (var t=0; t<treatments.length; t++) {
    ...
    var hours = 0;
    if (t === 0){
      hours = Math.floor((new Date().getTime() - tr.mills) / 1000 / 60 / 60);
    }else {
      hours = Math.floor((lastMills - tr.mills) / 1000 / 60 / 60);
    }
    var bgcolor = '';
    if (hours < 1.1 * 48){
      bgcolor = '#7fff00';
    ...
    table.append($('<tr>').addClass('border_bottom')
      ...
      .append($('<td>').css('background-color' , bgcolor).append(hours + " Stunden").append(t === 0 ? " und läuft noch" : "")));
  ...
  tableInsulinChange.append($('<tr>').css('background','gray')
    .append($('<th>').css('width','100px').attr('align','left').append("Wochentag"))
    .append($('<th>').css('width','80px').attr('align','left').append("Datum"))
    .append($('<th>').css('width','80px').attr('align','left').append(translate('Time')))
    .append($('<th>').css('width','300px').attr('align','left').append(translate('Event Type')))
  ...
  tableSensorChange.append($('<tr>').css('background','gray')
    .append($('<th>').css('width','100px').attr('align','left').append("Wochentag"))
    .append($('<th>').css('width','80px').attr('align','left').append("Datum"))
    .append($('<th>').css('width','80px').attr('align','left').append(translate('Time')))
    .append($('<th>').css('width','300px').attr('align','left').append(translate('Event Type')))
  ...
  tablePumpBatterieChange.append($('<tr>').css('background','gray')
    .append($('<th>').css('width','100px').attr('align','left').append("Wochentag"))
    .append($('<th>').css('width','80px').attr('align','left').append("Datum"))
    .append($('<th>').css('width','80px').attr('align','left').append(translate('Time')))
    .append($('<th>').css('width','300px').attr('align','left').append(translate('Event Type')))
