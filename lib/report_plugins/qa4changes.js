...
qa4changes.report = function report_qa4changes(datastorage, sorteddaystoshow, options) {
  ...
  for (t=0; t<treatments.length; t++) {
    ...
    bgcolor = '';
    if ((days * 24 + hours) < (7 * 24)){
      bgcolor = '	#7fff00';
    }
    else {
      if ((days * 24 + hours) < (8 * 24)){
        bgcolor = '#ffd700';
      } else {
        bgcolor = '#ff4500';
      }
  ...
  div.append('<div>', 'Ich strebe 2 Tage als Wechseldauer an. (grün bis 60 h, gelb bis 72h und alles darüber hinaus rot)');
  div.append(table);

  div.append('<h3>', 'Wann wurde das Insulin von mir gewechselt? Und wieviel Zeit war zwischen den Wechseln?');
  div.append('<div>', 'Ich strebe 6 Tage als Wechseldauer an. (grün bis 7 Tage, gelb bis 8 Tage und alles darüber hinaus rot)');
  ...
  div.append('<div>', 'Ich strebe mindestens 9 Tage als Wechseldauer an. (rot bis 8 Tage, gelb bis 9 Tage und alles darüber hinaus grün)');
  ...
  div.append('<div>', 'Ich strebe 20 Tage als Wechseldauer an. (grün bis 22 Tage, gelb bis 24 Tage und alles darüber hinaus rot)');
